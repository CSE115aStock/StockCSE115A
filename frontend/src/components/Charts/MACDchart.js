  ...
  */
  render() {
    ...
    const calculatedData =
      smaVolume50(macdCalculator(ema12(ema26(initialData))));
    ...
    return (
      ...
      >
        <Chart id={1} height={400}
          yExtents={[(d) =>
            [d.high, d.low], ema26.accessor(), ema12.accessor()]}
        ...
        >
          ...
          <BarSeries yAccessor={(d) => d.volume} fill={(d) =>
            d.close > d.open ? '#6BA583' : '#FF0000'} />
          <AreaSeries yAccessor={smaVolume50.accessor()}
            stroke={smaVolume50.stroke()} fill={smaVolume50.fill()}/>
        </Chart>
...
CandleStickChartWithMACDIndicator =
  fitWidth(CandleStickChartWithMACDIndicator);
